...
<div class="d-flex justify-content-between align-items-center">
    <h2 style="padding:2%;">Update Registration Data</h2>
</div>
<div class="mt-4">
    ...
    @endif
    @if(isset($register))
    <form action="{{ route('register.update', ['id' => $register->id]) }}" method="post">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div id="nomorTeleponError" class="text-danger"></div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('register.destroy', ['id' => $register->id]) }}" method="post">
                        @csrf
                        @method('DELETE')
